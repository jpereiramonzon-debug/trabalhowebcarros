...
<div class="container mt-5">
    ...
    <div class="list-group">
        <a href="listaveiculos.jsp" class="list-group-item list-group-item-action list-group-item-primary fs-5">Visualizar Veículos</a>
        <a href="${pageContext.request.contextPath}/simulacao/calcular" class="list-group-item list-group-item-action list-group-item-primary fs-5">Realizar Simulação de Financiamento</a>
    </div>
